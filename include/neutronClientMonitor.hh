...
#   endif
    ...
    NeutronEventClient *p_nEC;

    void checkUpdate(shared_ptr<PVStructure> const &structure);
public:
    MyMonitorRequester(int limit, bool quiet,NeutronEventClient *nEC)
    : MyRequester("MyMonitorRequester"),
      ...
      monitors(0), updates(0), overruns(0), last_pulse_id(0), missing_pulses(0), array_size_differences(0),p_nEC(nEC)
    {}
